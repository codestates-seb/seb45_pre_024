      ...
      <div className="footer_container">
        <nav className="footer_nav">
          ...
          <div className="stack_overflow">
            <h5 className="h5">STACK OVERFLOW</h5>
            <li className="li">Questions</li>
            <li className="li">Help</li>
          </div>
          <div className="team_notion">
            <h5 className="h5">TEAM</h5>
            <li className="li">
              <a
                className="a"
          ...
          <div className="member_fe">
            <h5 className="h5">MEMBER</h5>
            <li className="li">Frontend Developer</li>
            <li className="li">
              <a
                className="a"
          ...
          <div className="member_be">
            <h5 className="h5">&nbsp;</h5>
            <li className="li">Backend Developer</li>
            <li className="li">
              <a
                className="a"
