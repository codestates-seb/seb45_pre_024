...
public class AnswerService {
    ...
    public AnswerService(QuestionService questionService, QuestionRepository questionRepository, AnswerRepository answerRepository, AnswerCommentRepository answerCommentRepository, AnswerMapper answerMapper) {
...
//    }
    ...
    public void acceptAnswer(Answer answer, long memberId){
        ...
        answerRepository.changeAcceptedAndSave(answer);
        questionRepository.changeAcceptedAndSave(question);
    }
    ...
    public void deleteAnswer(long answerId, long memberId){
        ...
        answerComments.forEach(answerComment -> answerComment.setDeleted(true));
